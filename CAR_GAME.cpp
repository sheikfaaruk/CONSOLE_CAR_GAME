...
int enemyX[3];
int enemyFlag[3];
signed char car[4][4] = { (signed char)' ',(signed char)'±',(signed char)'±',(signed char)' ',
					(signed char)'0',(signed char)'±',(signed char)'±',(signed char)'0',
...
void play(){
	...
	gotoxy(WIN_WIDTH + 7, 2);cout<<"CONSOLE CAR GAME";
...
int main()
{
	...
	do{
		system("cls");
		gotoxy(10,5); cout<<" -------------------------- ";
		gotoxy(10,6); cout<<" |    CONSOLE CAR GAME    | ";
		gotoxy(10,7); cout<<" --------------------------";
